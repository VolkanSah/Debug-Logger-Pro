...
### What it does:
* **Catches Fatal Errors:** Detects and logs PHP errors that crash your site.
* **Logs Attacks:** Records requests from bots and "wannabe" hackers scanning for vulnerabilities.
* **Consolidates Your Logs:** Combines standard WordPress logs (`debug.log`) with your custom messages.
